...
function SwipeTutorial() {
  ...
  const steps = [
    { icon: "📱", text: "Parcourez les annonces", emoji: "👀" },
    { icon: "❤️", text: "Cette annonce vous intéresse ?", emoji: "✨" },
    { icon: "🎯", text: "Choisissez une de vos annonces", emoji: "📦" },
    { icon: "👉", text: "Swipe à droite", emoji: "💫" },
    { icon: "✅", text: "Proposition envoyée !", emoji: "🎉" },
  ];
            ...
            >
              ...
              >
                <span className="inline-flex items-center gap-2">
                  L'app qui fait <em className="font-semibold not-italic">tout</em> ✨
                </span>
                <br />
                <span className="text-lg text-white/80">
                  Troc • Vente • Achat • Transport de Colis • Covoiturage
                </span>
              </motion.p>
              ...
              >
                ...
                <a
                  href="#"
                  className="group inline-flex items-center justify-center px-6 py-4 bg-black text-white rounded-2xl font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300"
                >
                ...
                <a
                  href="#"
                  className="group inline-flex items-center justify-center px-6 py-4 bg-white text-gray-900 rounded-2xl font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300"
                >
                  <svg className="w-8 h-8 mr-3" viewBox="0 0 24 24" fill="currentColor">
              ...
              >
                ...
                <div className="text-center lg:text-left">
                  <div className="text-4xl font-bold mb-2 flex items-center gap-2">
                    5K+ <span className="text-2xl">📦</span>
                  </div>
                  <div className="text-white/80 text-sm">Annonces</div>
                </div>
                <div className="text-center lg:text-left">
                  <div className="text-4xl font-bold mb-2 flex items-center gap-2">
                    2K+ <span className="text-2xl">🤝</span>
                  </div>
                  <div className="text-white/80 text-sm">Échanges réussis</div>
                </div>
              </motion.div>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Plus besoin de jongler entre plusieurs apps. Trokacha centralise tous vos besoins d'échange en Algérie
            </p>
          </motion.div>
            ...
            {[
              {
                emoji: "🔄",
                title: "Troc & Échange",
                description: "Échangez vos biens avec d'autres utilisateurs en toute simplicité",
                color: "from-red-500 to-pink-500",
              },
              {
                emoji: "🛍️",
                title: "Vente & Achat",
                description: "Vendez ou achetez des articles en toute sécurité",
                color: "from-blue-500 to-cyan-500",
              },
              {
                emoji: "🚚",
                title: "Transport de Colis",
                description: "Envoyez ou transportez des colis partout en Algérie",
              ...
              },
              {
                ...
                description: "Système de swipe ultra-rapide et simple à utiliser",
                color: "from-purple-500 to-pink-500",
              },
              {
                emoji: "🎨",
                title: "Design Élégant",
                description: "Une expérience visuelle moderne et agréable",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
              Rejoignez des milliers d'utilisateurs qui font déjà confiance à Trokacha pour tous leurs échanges
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center px-8 py-4 bg-black text-white rounded-2xl font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300"
              >
                <svg className="w-8 h-8 mr-3" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                </svg>
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-gray-900 rounded-2xl font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300"
              >
                <svg className="w-8 h-8 mr-3" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                </svg>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400">
                L'app algérienne qui fait tout
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <div className="text-gray-500 text-sm">
              © 2025 Trokacha. Tous droits réservés.
            </div>
          </div>
        </div>
      </footer>
