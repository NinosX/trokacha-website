          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white animate-fade-in-up">
              ...
              <div className="flex flex-row gap-2 sm:gap-4 mb-10 animate-fade-in-up delay-500">
                ...
                <div className="inline-flex items-center justify-center px-2 sm:px-6 py-2 sm:py-4 bg-black/50 text-white/70 rounded-lg sm:rounded-2xl font-semibold cursor-not-allowed flex-1 sm:flex-none">
                  ...
                  <div className="text-start">
                    ...
                    <div className="text-xs sm:text-lg font-bold">{t("hero.appStore")}</div>
                  </div>
                </div>
